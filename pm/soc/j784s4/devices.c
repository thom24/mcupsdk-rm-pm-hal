...
static const struct dev_clk_data MAIN_dev_clk_data[3182] __attribute__((__section__(".const.devgroup.MAIN"))) = {
...
const struct dev_data *const soc_device_data_arr[J784S4_DEV_ACSPCIE_BUFFER1 + 1U] = {
