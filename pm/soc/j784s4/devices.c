...
static const struct dev_clk_data MAIN_dev_clk_data[3166] __attribute__((__section__(".const.devgroup.MAIN"))) = {
...
const struct dev_data *const soc_device_data_arr[J784S4_DEV_GLUELOGIC_ACSPCIE1_BUFFER + 1U] = {
