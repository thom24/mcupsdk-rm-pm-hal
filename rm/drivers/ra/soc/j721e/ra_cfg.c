...
static const struct rm_mmr mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG_GCFG = {
	.fwl_id		= RM_MMR_FWL_INVALID,
	.fwl_ch_start	= 0U,
	.fwl_ch_end	= 0U,
	.base		= 0x285d0000U,
...
static const struct rm_mmr mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_FIFOS = {
	.fwl_id		= 6272U,
	.fwl_ch_start	= 0U,
	.fwl_ch_end	= 285U,
	.base		= 0x2b000000U,
...
static const struct rm_mmr mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG_MON = {
	.fwl_id		= 6160U,
	.fwl_ch_start	= 286U,
	.fwl_ch_end	= 317U,
	.base		= 0x2a280000U,
...
static const struct rm_mmr mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG = {
	.fwl_id		= RM_MMR_FWL_INVALID,
	.fwl_ch_start	= 0U,
	.fwl_ch_end	= 0U,
	.base		= 0x28440000U,
...
static const struct rm_mmr mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG_RT = {
	.fwl_id		= 6160U,
	.fwl_ch_start	= 0U,
	.fwl_ch_end	= 285U,
	.base		= 0x2b800000U,
...
static const struct ra_ring_type ring_types_MCU_NAVSS0_RINGACC_0[5] = {
	{
		.start = 0U,
		.end = 1U,
		.type = RA_STANDARD_RING,
		.utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_UDMAP_TX_H),
	},
	{
		.start = 2U,
		.end = 47U,
		.type = RA_STANDARD_RING,
		.utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_UDMAP_TX),
	},
	{
		.start = 48U,
		.end = 49U,
		.type = RA_STANDARD_RING,
		.utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_UDMAP_RX_H),
	},
	{
		.start = 50U,
		.end = 95U,
		.type = RA_STANDARD_RING,
		.utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_UDMAP_RX),
	},
	{
		.start = 96U,
		.end = 255U,
		.type = RA_STANDARD_RING,
		.utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_GP),
	},
};
 ...
 */
static struct ra_used_mapping rom_usage_MCU_NAVSS0_RINGACC_0[13U] = {
	{
		.ring = 0U,
		.cleared = SFALSE,
	},
...
struct ra_instance ra_inst[] = {
	...
	{
		.id = J721E_DEV_MCU_NAVSS0_RINGACC_0,
		.root_id = J721E_DEV_NAVSS_MCU_J7_MCU_0,
		.initialized = SFALSE,
		.devgrp = SOC_DEVGRP_J721E_MCU_WAKEUP | SOC_DEVGRP_J721E_DMSC_INTERNAL,
		.gcfg = &mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG_GCFG,
		.cfg = &mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG,
		.rt = &mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG_RT,
		.mon = &mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_CFG_MON,
		.fifos = &mmr_MCU_NAVSS0_RINGACC_0_UDMASS_RINGACC0_FIFOS,
		.n_ring = RA_MCU_NAVSS0_RINGACC_0_MAX_INDEX,
		.ring_oes_offset = RA_MCU_NAVSS0_RINGACC_0_RING_OES_EVT_INDEX_OFFSET,
		.ring_types = &ring_types_MCU_NAVSS0_RINGACC_0[0U],
		.n_ring_type = ARRAY_SIZE(ring_types_MCU_NAVSS0_RINGACC_0),
		.err_evt_index = RA_GCFG_ERROR_EVT_INDEX,
		.err_evt_utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_ERROR_OES),
		.virtid_utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_VIRTID),
		.n_ring_mon = RA_MCU_NAVSS0_RINGACC_0_MONITOR_MAX_INDEX,
		.ring_mon_utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_RINGACC_0, RESASG_SUBTYPE_RA_MONITORS),
		.ring_mon_oes_offset = RA_MON_OES_EVT_INDEX_OFFSET,
		.rom_usage = &rom_usage_MCU_NAVSS0_RINGACC_0[0U],
		.n_rom_usage = ARRAY_SIZE(rom_usage_MCU_NAVSS0_RINGACC_0),
	},
};
