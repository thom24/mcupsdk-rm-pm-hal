...
static const struct rm_mmr mmr_MCU_NAVSS0_PROXY_0_PROXY0_TARGET0_DATA = {
	.fwl_id		= 6256U,
	.fwl_ch_start	= 0U,
	.fwl_ch_end	= 63U,
	.base		= 0x2a500000U,
...
struct proxy_instance proxy_inst[PROXY_INST_COUNT] = {
	...
	{
		.id = J721E_DEV_MCU_NAVSS0_PROXY_0,
		.initialized = SFALSE,
		.devgrp = SOC_DEVGRP_J721E_MCU_WAKEUP,
		.cfg = &mmr_MCU_NAVSS0_PROXY_0_PROXY0_BUF_CFG,
		.target0_data = &mmr_MCU_NAVSS0_PROXY_0_PROXY0_TARGET0_DATA,
		.n_proxies = PROXY_MCU_NAVSS0_PROXY_0_PROXY_MAX_INDEX,
		.proxy_utype = RESASG_UTYPE(J721E_DEV_MCU_NAVSS0_PROXY_0, RESASG_SUBTYPE_PROXY_PROXIES),
	},
};
